...
export function AdminStudentDirectoryRow({
  ...
  return (
    <li
      className={cn(
        "group/directoryRow rounded-lg border border-slate-300/50 border-l-4 border-l-brand-sky/80 bg-gradient-to-br from-brand-sky/5 via-slate-50/98 to-brand-lime/6 shadow-sm",
